...
6. When the user explicitly asks to begin work on the story, use `/singularity-flow:start <JIRA-ID> --jira`; that operation persists `source.json` and `USER-STORY.md` on the exact Jira-ID branch.
