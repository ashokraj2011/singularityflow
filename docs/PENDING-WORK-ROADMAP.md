...
| Governed comprehension | Read-only, non-authoritative P0 code-local contract, closed registries, authority ADR, and mutation tripwires exist | Finish the `CMP-P0-001` supported-platform/package proof; keep record/enforce unavailable | [CMP roadmap](CMP-ROADMAP.md) |
