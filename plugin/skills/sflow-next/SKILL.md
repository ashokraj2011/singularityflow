...
7. If any step fails, run `singularity-flow logs --level error --tail 40` and report the recorded message, command, and exit code verbatim before proposing a fix. Never re-run a failing action without first reading why it failed.
