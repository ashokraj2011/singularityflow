...
5. Report the receipt and exact effects. A deterministic route/packet kernel exists, but executable `/sflow-revise` is disabled. Never substitute ordinary Story document upload or claim a revision ran.
