...
version: 1
---
The world model provides repository-grounded views used during governed generation. Build only declared views, review their provenance, and respect off, warn, or enforce grounding policy.
