...
- **Shell:** `sflow home`, `sflow choices`. Run `singularity-flow home --help` for the exact forms supported by this build.
- **Copilot:** `/sf-home`. The skill must preserve the CLI result and ask before any governed mutation.
