...
const PAGES = Object.freeze({
  ...
  capability: {
    ...
    description: [
      ...
      '',
      'Repository onboarding starts from an exact credential-free Git URL. `capability onboard`',
      'returns one ref-bound preview with exact effects and preserved data; its plan ID must be',
      'confirmed before any write. Recognized state can restore missing configuration from its',
