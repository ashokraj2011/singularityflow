...
singularity-flow auto plan "<REQUIREMENT>" [--capability ID] [--work-type ID] [--work-id ID] [--from-branch BRANCH] [--pace PACE] [--until STOP] [--json]
singularity-flow auto show-plan <PLAN-ID> [--json]
singularity-flow auto start <PLAN-ID> --confirm <PLAN-SHA256> [--json]
singularity-flow auto status|report <FLIGHT-ID> [--json]
singularity-flow auto pause|halt <FLIGHT-ID> [--json]
