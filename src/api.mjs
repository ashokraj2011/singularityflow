 ...
 */
export function createSflow({ root = repoRoot(), faultRepairPolicy = {}, executionEnvironment = null } = {}) {
  return createFaultRepairApi(root, { policy: faultRepairPolicy, executionEnvironment });
}
