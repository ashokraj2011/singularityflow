...
Usage:
  ...
  singularity-flow wm ast context [--paths PATH]... [--all] [--max-files N] [--max-bytes N] [--json]
  singularity-flow wm ast query --predicate symbol|import|language|path --value VALUE [--paths PATH]... [--json]
