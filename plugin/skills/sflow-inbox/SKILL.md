...
5. Run `singularity-flow session attach <WORK-ID> --json` for the exact selection. This may create a local tracking branch and fast-forward it, but it must never merge, rebase, reset, stash, or discard local work.
