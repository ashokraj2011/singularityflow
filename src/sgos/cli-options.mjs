...
export const SGOS_CLI_OPTIONS = Object.freeze({
  ...
  'authority-store': Object.freeze({
    ...
    'trust-scaffold': optionSet(...STORE, 'mode'),
    publish: optionSet(...STORE, 'confirm'),
    sync: optionSet(...STORE, 'confirm'),
  ...
  learn: Object.freeze({
    ...
    'progress-import': optionSet('transfer', 'confirm'),
    check: optionSet(...PACK_READ, 'role', 'pack', 'module', 'answers'),
    reset: optionSet('confirm'),
