...
title: Initiative lifecycle and multi-repository delivery
aliases:
  - initiative
  - multi-repository
  - portfolio
...
version: 1
---
An Initiative coordinates planning artifacts, governed approvals, Story materialization, repository dependencies, and completion across a capability-defined workspace.

## Purpose and prerequisites

Use this topic when the current goal matches **initiative lifecycle**. Start in a governed checkout unless the command explicitly operates on installation or machine-local workspace state. Run `sflow doctor` when setup, identity, credentials, or repository health is uncertain, and use `sflow status` or `sflow home` to confirm the selected work before a mutation.

## Use it from each surface

- **Shell:** `sflow initiative`. Run `singularity-flow initiative --help` for the exact forms supported by this build.
...
Continue with `sflow explain epics-and-planning`, `sflow explain capability-management`, `sflow explain pull-requests-and-stacks`.
