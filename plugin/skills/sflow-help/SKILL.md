...
4. Explain the ordered phases, required artifact for each phase, suggested working lenses, human approval authority groups, and approval threshold.
...
6. If approval is pending, show both approve and reject paths and remind the user that authority comes from their Git/GitHub identity; a working lens cannot grant it.
