...
import { GitRemoteSession, runRemoteGit, runRemoteGitAsync } from './git-execution.mjs';
  ...
  return withLeadCheckout(leadUrl, `Map capability ${capabilityId}`,
    ...
    if (urls.length) {
      ...
      for (const url of urls) {
        ...
        const branch = observedDefaultBranch(
          url,
