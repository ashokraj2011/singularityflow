...
const M = (label: string, detail?: string): Message => Object.freeze({ label, detail });

export const RESULT_MESSAGES: Readonly<Record<string, Message>> = Object.freeze({
  /**
 ...
 */
export function message(code: string, slots: Slots = {}): Message {
