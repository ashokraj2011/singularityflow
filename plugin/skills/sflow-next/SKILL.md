...
3. Follow the selected skill. Delegate terminally to `/sf-code` and stop when it returns; it owns publication. For another generative phase, compose grounding, complete the Human clarification checkpoint, follow `/sf-phase`, and stop. Never republish after delegation.
