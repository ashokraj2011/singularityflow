...
1. Your display name.
2. Your working role from a selectable list. The role suggests a planning persona; it does not restrict which persona or phase you may use.
