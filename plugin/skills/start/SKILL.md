...
4. If `.sdlc/workflow.yml` is absent, run `singularity-flow init` on the base branch and ask the user to commit the generated workflow, templates, personas, and builder prompt before starting work.
