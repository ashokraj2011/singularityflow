...
export const CMP_DIAGNOSTIC_CODES = Object.freeze([
  ...new Set([
    ...
    'CMP_BACKFILL_ASSURANCE_INVALID',
    'CMP_BACKFILL_INTEGRITY_INVALID',
    'CMP_BACKFILL_LIMIT',
    'CMP_BACKFILL_REFERENCE_INVALID',
    'CMP_BACKFILL_SCHEMA_INVALID',
    'CMP_BACKFILL_SCOPE_INVALID',
    'CMP_BACKFILL_SOURCE_STALE',
    'CMP_BROWNFIELD_MANIFEST_INVALID',
    ...
    'CMP_GRAPH_LIMIT',
    'CMP_REPLAY_QUERY_INVALID',
    'CMP_REPLAY_SOURCE_INVALID',
    'CMP_EXPERIMENTAL_FLAG_REQUIRED',
    'CMP_RECORD_PREVIEW_INVALID',
    'CMP_LEGACY_TOUCHED',
    ...
    'CMP_SOURCE_LIMIT',
    'CMP_SOURCE_LIMIT_INVALID',
    'CMP_SOURCE_MANIFEST_INVALID',
    'CMP_SOURCE_OFFSET_INVALID',
    'CMP_SOURCE_REFERENCE_INVALID',
    'CMP_SOURCE_REFERENCE_STALE',
    'CMP_SOURCE_REGION_INVALID',
    'CMP_SOURCE_SIDE_INVALID',
    'CMP_SOURCE_UNAVAILABLE',
    'CMP_SPLIT_PENDING',
    'CMP_STRUCTURE_UNAVAILABLE',
    'CMP_WALKTHROUGH_ASSURANCE_INVALID',
    'CMP_WALKTHROUGH_CANDIDATE_INVALID',
    'CMP_WALKTHROUGH_CLAIM_CLASS_INVALID',
    'CMP_WALKTHROUGH_DECISION_UNAVAILABLE',
    'CMP_WALKTHROUGH_DEPENDENCY_INVALID',
    'CMP_WALKTHROUGH_DRAFT_IN_CANDIDATE',
    'CMP_WALKTHROUGH_EVIDENCE_UNAVAILABLE',
    'CMP_WALKTHROUGH_INTEGRITY_INVALID',
    'CMP_WALKTHROUGH_LIMIT',
    'CMP_WALKTHROUGH_REFERENCE_INVALID',
    'CMP_WALKTHROUGH_REVALIDATION_INVALID',
    'CMP_WALKTHROUGH_SCHEMA_INVALID',
    'CMP_WALKTHROUGH_VALIDATOR_UNAVAILABLE'
  ])
].sort());
