...
const families = [
  ...
  family({ id: 'world-model-projection-receipt', currentVersion: 1, immutable: true, paths: [/^singularity\/world-model\/receipts\/projections\/[^/]+\.json$/] }),
  family({ id: 'world-model-projection-refusal', currentVersion: 1, immutable: true, paths: [/^singularity\/world-model\/refusals\/projections\/[^/]+\.json$/] }),
  family({ id: 'architecture-fact-set', currentVersion: 1, immutable: true }),
  family({ id: 'architecture-intent', currentVersion: 1, immutable: true, paths: [/^singularity\/work-items\/[^/]+\/context\/architecture\/architecture-intent\.json$/] }),
  ...
  family({ id: 'fos-offline-policy', currentVersion: 1 }),
  family({ id: 'fos-offline-snapshot', currentVersion: 1 }),
  ...
  // Repository-independent local deliverables use the same migration authority as every other
  // durable SFlow record. Public bundle `schema` identifiers remain stable protocol names; this
  // numeric version is the reader/writer compatibility boundary enforced by MIG.
  family({
    id: 'local-mode-state', currentVersion: 1,
    paths: [/^\$local\/local-mode\/stories\/LOC-[0-9A-F]{32}\/ledger\/state\.json$/]
  }),
  family({ id: 'local-mode-operation', currentVersion: 1 }),
  family({ id: 'local-mode-audit', currentVersion: 1 }),
  family({ id: 'local-input-manifest', currentVersion: 1, immutable: true }),
  family({ id: 'local-output-manifest', currentVersion: 1, immutable: true }),
  family({ id: 'local-intent', currentVersion: 1, immutable: true }),
  family({ id: 'local-workflow', currentVersion: 1, immutable: true }),
  family({ id: 'local-policy', currentVersion: 1, immutable: true }),
  family({ id: 'local-classification', currentVersion: 1, immutable: true }),
  family({ id: 'local-disclosure-plan', currentVersion: 1, immutable: true }),
  family({ id: 'local-verification-plan', currentVersion: 1, immutable: true }),
  family({ id: 'local-candidate', currentVersion: 1, immutable: true }),
  family({ id: 'local-claims', currentVersion: 1, immutable: true }),
  family({ id: 'local-evidence-receipt', currentVersion: 1, immutable: true }),
  family({ id: 'local-evidence-index', currentVersion: 1, immutable: true }),
  family({ id: 'local-review-authority', currentVersion: 1, immutable: true }),
  family({ id: 'local-review-subject', currentVersion: 1, immutable: true }),
  family({ id: 'local-review-decision', currentVersion: 1, immutable: true }),
  family({ id: 'local-review-envelope', currentVersion: 1, immutable: true }),
  family({ id: 'local-approval-index', currentVersion: 1, immutable: true }),
  family({ id: 'local-action-authority', currentVersion: 1, immutable: true }),
  family({ id: 'local-authorization-subject', currentVersion: 1, immutable: true }),
