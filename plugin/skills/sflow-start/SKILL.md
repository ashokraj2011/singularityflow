...
9. Offer `/sflow-documents upload` for requirements files, images, PDFs, `.fig` files, or Figma links during the configured initial phases.
10. Do not generate the active artifact unless also requested. Recommend `/sflow-phase`.
