...
4. Run `singularity-flow epic requirements prepare`. Read the complete governed context that it prints: phase contract, working lens, Jira snapshot, pinned sources, question ledger, and workspace repository registry. Repository grounding is added later, after each Story has its canonical branch.
