...
export const BOOLEAN_OPTIONS = Object.freeze(new Set([
  ...
  'saved-buffers-confirmed', 'search-known', 'semantic', 'shadow', 'skip-checks', 'smart-detect', 'staged', 'stale', 'state-only', 'strict', 'submission-readiness', 'terminal', 'timings', 'today', 'update', 'write',
  'yes',
