...
function BusinessNavigation({
  ...
  return <header className="business-navigation">
    <div className="business-brand" aria-label="Singularity Business">
      <span>S</span>
      <div><strong>Singularity</strong><small>{workspaceContext}</small></div>
    </div>
    ...
    <div className="business-navigation-tools">
      ...
      <div className="repo-switcher">
        <button className="business-project-switcher" type="button" aria-expanded={repositoryMenu} aria-haspopup="menu" onClick={() => setRepositoryMenu(!repositoryMenu)}>
          <span className="repo-icon">{repoName?.slice(0, 1).toUpperCase()}</span>
...
function InitiativeStudio({ data, editor, setEditor, saveEditor, downloadFile, action, reload, bootstrapPortfolio, openPlanning, localRole, jiraAccount, entryTab = null }) {
